class SanctuarySupportBot:
    def __init__(self):
        self.knowledge_base = {
            ...
            "api": "🔐 Your keys are encrypted with advanced Fernet security and routed securely through respective cloud broker endpoints (Binance, Alpaca, OANDA).",
    ...
    def get_response(self, query):
        ...
        for keyword, answer in self.knowledge_base.items():
            if keyword in query_lower:
                return answer
        return "🧸✨ I am your Guardian Support Bot. Every parameter in our sanctuary is optimized for your safety, love, and success. Ask me anything about your vault, multi-broker setups, or live execution tiers!"
